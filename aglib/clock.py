...
__version__ = '$Id: game_clock.py 103 2011-01-08 08:02:42Z stabbingfinger@gmail.com $'
...
class Clock(object):
    ...
    def __init__(self, ticks_per_second=25, max_fps=60, use_wait=False, max_frame_skip=5):
